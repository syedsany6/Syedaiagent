...
Want to understand A2A design principles and external partners supporting A2A?
[Read our blog post](https://developers.googleblog.com/en/a2a-a-new-era-of-agent-interoperability/)

Interested to contribute and know more about the internals of A2A protocol?
[Collaborate on Github](https://github.com/google/A2A)

Or continue by [watching a demo video](demos.md) or [read our technical documentation](documentation.md)
